...
class Setup
{
    ...
    {
        $arr = [];
        $table_name = readline("What's the table name(like user): ");
        ...
        if($join == 'yes')
        {
            $parent_table_name = readline("Enter parent table name(like user): ");
            readline_read_history($arr['parent_table_name']=$parent_table_name);

            $parent_table_col = readline("Enter table col name(like id from user table): ");
            readline_read_history($arr['parent_table_col']=$parent_table_col);

            $join_table_name = readline("What's table name(like domain): ");
            readline_read_history($arr['join_table_name']=$join_table_name);

            $join_table_col = readline("What's table col name(like domain_id): ");
            readline_read_history($arr['join_table_col']=$join_table_col);

            $join_table_col_name = readline("What's your excepted col name(like subdomain): ");
